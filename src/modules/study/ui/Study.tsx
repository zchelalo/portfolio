...
function Study() {
  ...
  return (
    ...
    >
      <main>
        {studies.map(study => (
          <div key={study.id} className='rounded bg text border-2 border-violet-900 flex flex-col sm:flex-row sm:flex-wrap sm:justify-between sm:items-center p-2 mt-4'>
